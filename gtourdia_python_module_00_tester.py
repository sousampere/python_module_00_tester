...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog='Gtourdia python module 00 tester',
        description='Python_module_00 tester',
        epilog='If something is broken, please contact report it github : @sousampere')
    parser.add_argument('--ex0', action='store_true')
    parser.add_argument('--ex1', action='store_true')
    parser.add_argument('--ex2', action='store_true')
    parser.add_argument('--ex3', action='store_true')
    ...
    parser.add_argument('--ex7', action='store_true')
